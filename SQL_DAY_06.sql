...
INSERT INTO customerss (customer_id, name, email) VALUES
...
INSERT INTO ordersss (order_id, customer_id, order_date, amount) VALUES
...
where customer_id NOT IN (
							select customer_id from ordersss
...
select c.*
from customerss c
left join ordersss o
  on c.customer_id = o.customer_id
  and extract(month from o.order_date) = extract(month from current_date)-1
